 ...
 * BASIC
 */
$config['site_title'] = 'Ronald Langeveld';              // Site title
 ...
 * THEME
 */
$config['theme'] = 'minimal';                // Set the theme (defaults to "default")
 ...
 * TIMEZONE
 */
$config['timezone'] = 'Africa/Johannesburg';                 // Timezone may be required by your php install
